...
public class MetaBaseBlockItem extends BlockItem implements ItemInterfaces.IMustAddToCreativeTab, ICustomTooltip
{
    ...
    public MetaBaseBlockItem(Block block, Properties properties, boolean addToCreative)
    {
        super(block, properties);
        this.addToCreative = addToCreative;
    }

    public MetaBaseBlockItem(Block block, Properties properties)
    {
