...
public class MetaBucketItem extends BucketItem implements ItemInterfaces.IMustAddToCreativeTab, ICustomTooltip
{
    ...
    public MetaBucketItem(Fluid content, Properties properties)
    {
