...
public abstract class MetaContainerMenu extends AbstractContainerMenu implements IScreenMessageReceiver, IGuiContextInfoProvider
{
    ...
    protected MetaContainerMenu(@NotNull MenuContext ctx)
    {
    ...
    protected static @NotNull MenuContext blockCtx(MenuType<?> pMenuType, int pContainerId, BlockEntity be)
    {
        ...
        {
            be.setChanged();
            if(be instanceof MetaBaseBlockEntity bioBE)
