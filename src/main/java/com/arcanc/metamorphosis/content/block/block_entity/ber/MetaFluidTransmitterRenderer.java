...
public class MetaFluidTransmitterRenderer implements BlockEntityRenderer<MetaFluidTransmitter>
{
    ...
    public MetaFluidTransmitterRenderer(BlockEntityRendererProvider.Context ctx)
    {

    }

    @Override
    public void render(@NotNull MetaFluidTransmitter blockEntity,
                       float partialTicks,
                       ...
                       int packedOverlay)
    {
        ...
        for (MetaFluidTransmitter.PathData data : blockEntity.getPathData())
    ...
    @Override
    public boolean shouldRenderOffScreen(@NotNull MetaFluidTransmitter blockEntity)
    {
        return true;
    }

    @Override
    public @NotNull AABB getRenderBoundingBox(@NotNull MetaFluidTransmitter blockEntity)
    {
