...
import com.arcanc.metamorphosis.content.block.MetaBaseBlock;
...
public class NorphBlock extends MetaBaseBlock
{
                           ...
                           @NotNull RandomSource random)
    {
        ...
        if (    !testState.isAir() &&
                !testState.is(MetaBlockTags.NORPH_SOURCE) &&
                !testState.is(MetaBlockTags.NORPH) &&
                !testState.is(MetaBlockTags.NORPH_AVOID))
        {
