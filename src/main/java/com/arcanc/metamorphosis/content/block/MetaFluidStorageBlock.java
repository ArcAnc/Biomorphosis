...
public class MetaFluidStorageBlock extends MetaNorphDependentBlock<MetaFluidStorage>
{
    ...
    public static final MapCodec<MetaFluidStorageBlock> CODEC = simpleCodec(MetaFluidStorageBlock :: new);

    public MetaFluidStorageBlock(Properties blockProps)
    {
        super(MetaFluidStorage :: new, blockProps);
    }
    ...
    @Override
    protected @NotNull MapCodec<MetaFluidStorageBlock> codec()
    {
        return CODEC;
    }
}
