...
public class MetaEntityTagsProvider extends EntityTypeTagsProvider
{
    public MetaEntityTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider)
    {
