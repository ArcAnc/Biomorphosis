...
public record ResourcesDisplay(MetaBaseRecipe.ResourcesInfo resourcesInfo) implements SlotDisplay
{
    public static final MapCodec<ResourcesDisplay> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
                    MetaBaseRecipe.ResourcesInfo.CODEC.fieldOf("resources").forGetter(ResourcesDisplay :: resourcesInfo)).
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ResourcesDisplay> STREAM_CODEC = StreamCodec.composite(
            MetaBaseRecipe.ResourcesInfo.STREAM_CODEC,
