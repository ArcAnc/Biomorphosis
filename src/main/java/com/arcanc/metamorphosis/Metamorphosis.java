...
package com.arcanc.metamorphosis;

import com.arcanc.metamorphosis.content.event.ClientEvents;
import com.arcanc.metamorphosis.content.event.CommonEvents;
...
{
    public Metamorphosis(@NotNull IEventBus modEventBus, ModContainer modContainer)
    {
