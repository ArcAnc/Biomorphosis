...
import com.arcanc.metamorphosis.integration.jei.ingredient.IngredientWithSizeHelper;
import com.arcanc.metamorphosis.integration.jei.ingredient.IngredientWithSizeRenderer;
import com.arcanc.metamorphosis.integration.jei.ingredient.StackWithChanceHelper;
import com.arcanc.metamorphosis.integration.jei.ingredient.StackWithChanceRenderer;
...
@JeiPlugin
public class MetaJeiPlugin implements IModPlugin
{
    @Override
    public void registerIngredients(@NotNull IModIngredientRegistration registration)
    {
        registration.register(MetaIngredientTypes.STACK_WITH_CHANCE_TYPE,
                Set.of(),
                new StackWithChanceHelper(),
                new StackWithChanceRenderer(),
                StackWithChance.CODEC);

       registration.register(MetaIngredientTypes.INGREDIENT_WITH_SIZE_TYPE,
               Set.of(),
