...
package com.arcanc.metamorphosis.util;
...
public class Database
{
    ...
    public static final String MOD_NAME = "Metamorphosis";
    ...
    public static final class Integration
    {
        ...
        public static final class JeiInfo
        {
            ...
            public static final String WITH_ACID = rl("jei.with_boost.acid.title").toLanguageKey();
        }
    }
