...
public class Captain extends AbstractPalladin implements Merchant
{
	@Nullable
	...
	{
		VillagerTrades.ItemListing[] listing = Trades.getOffers(PalladinOrders.BASE_ORDER, Trades.PalladinTraderType.CAPTAIN);
		if (listing == null)
			return;
