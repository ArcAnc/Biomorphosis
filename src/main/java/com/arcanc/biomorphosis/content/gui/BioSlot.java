...
package com.arcanc.biomorphosis.content.gui;
...
public class BioSlot extends SlotItemHandler
{
    ...
    public BioSlot(AbstractContainerMenu menu, IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
    ...
    public static class Output extends BioSlot
    {
    ...
    public static class FluidContainer extends BioSlot
    {
    ...
    public static class Ghost extends BioSlot
    {
