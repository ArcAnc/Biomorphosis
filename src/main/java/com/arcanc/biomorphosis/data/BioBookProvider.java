...
public class BioBookProvider extends BioRegistryData
{
    ...
    protected void addContent()
    {
	    ...
	    addPage(Database.GUI.GuideBook.Pages.V2611.location(), BookPageBuilder.newPage().
			    setAuthor("ArcAnc").
			    setTitle(Database.GUI.GuideBook.Pages.V2611.titleLangKey()).
			    setText(Database.GUI.GuideBook.Pages.V2611.textLangKey()).
			    setChapter(Database.GUI.GuideBook.Chapters.TITLE.location()).
			    addTags("Patch Notes").
			    end());
	    addPage(Database.GUI.GuideBook.Pages.V262.location(), BookPageBuilder.newPage().
			    setAuthor("ArcAnc").
			    setTitle(Database.GUI.GuideBook.Pages.V262.titleLangKey()).
			    setText(Database.GUI.GuideBook.Pages.V262.textLangKey()).
			    setChapter(Database.GUI.GuideBook.Chapters.TITLE.location()).
			    addTags("Patch Notes").
			    end());
