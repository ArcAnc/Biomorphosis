...
public class EnUsProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
		...
		this.add(Database.GUI.GuideBook.Pages.FLESH.textLangKey(), "The first thing you must understand, little one, is flesh. Everything begins with flesh. It is the seed of life — and of us. Harvest it from the living. Tear it from Zombies, Villagers, Horses… all bodies serve. Each will give you </item;biomorphosis:flesh_piece/>Gather enough, and you may compress the pieces into a single, pulsating mass. Use this method: </recipe;minecraft:crafting_shaped;minecraft:flesh/>The Hive is built from flesh. Remember that" );
		...
		this.add(Database.GUI.GuideBook.Pages.CHAMBER.textLangKey(), "Now... the Chamber. You cannot simply build it. Nothing of ours is built — it is grown. The Chamber is the heart of creation. Through it, the Hive expands. Without it, you are nothing. To grow one, you’ll need this: </recipe;minecraft:crafting_shaped;biomorphosis:multiblock_morpher/>But remember, this will be the last thing you can obtain the human way. From now on — everything must be grown. Drop the required matter onto the Morpher, and it will take shape. Do not interrupt the process... It screams when disturbed. Curious what’s needed? Good. You’ll need: " + multiblockParts(Database.rl("chamber")));
		
		this.add(Database.GUI.GuideBook.Pages.STORAGES.titleLangKey(), "</block;biomorphosis:chest/>Storages");
		this.add(Database.GUI.GuideBook.Pages.STORAGES.textLangKey(), "To grow within the Chamber, you’ll need resources — flesh, fluids, essence. They must be stored, contained, like organs within a body. Use these to shape our vessels: </recipe;biomorphosis:chamber;biomorphosis:chamber/fluid_storage_from_chamber/>and</recipe;biomorphosis:chamber;biomorphosis:chamber/chest_from_chamber/>Each will serve as part of the Hive’s anatomy — one holds fluids, the other, matter");
