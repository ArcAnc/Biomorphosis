...
public class RenderHelper
{
    ...
    public static ItemStack getStackAtCurrentTime(IngredientWithSize ingredient)
    {
        return getStackAtCurrentTime(ingredient.
		        getItems().toList());
    }

    public static ItemStack getStackAtCurrentTime(SizedIngredient ingredient)
    {
        return getStackAtCurrentTime(Arrays.stream(ingredient.getItems()).toList());
    }

    public static ItemStack getStackAtCurrentTime(Ingredient ingredient)
    {
        return getStackAtCurrentTime(List.of(ingredient.getItems()));
    }

    public static ItemStack getStackAtCurrentTime(List<ItemStack> items)
    {
	...
	public static class Gui
	{
		...
		public static int scaledWidthCoord(Screen screen, int localWidth)
		{
			return (int) ((float)localWidth * screen.getMinecraft().getWindow().getGuiScaledWidth() / BASE_WIDTH);
		}
		
		public static int scaledHeightCoord(Screen screen, int localWidth)
		{
			return (int) ((float)localWidth * screen.getMinecraft().getWindow().getGuiScaledHeight() / BASE_HEIGHT);
		}
		
		public static int getScreenWidth(Screen screen, float percent)
		{
			return (int) (screen.width * percent);
		}
		
		public static int getScreenHeight(Screen screen, float percent)
		{
